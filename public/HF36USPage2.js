...
function HFDrumsPag2() {
  ...
  acidHFP2 = document.getElementById("acidHFP2").value;
  HFHFP2 = document.getElementById("HFHFP2").value;
  SO2HFP2 = document.getElementById("SO2HFP2").value;
...
function HFLines() {
  ...
  async function ReadHFText() {
    ...
    for (let index = 0; index < drumsHFP2Array.length; index++) {
      ...
      acidHFArray.push(acidHFP2);
      HFHFP2Array.push(HFHFP2);
      SO2HFP2Array.push(SO2HFP2);
      oggiHFP2.push(today);
